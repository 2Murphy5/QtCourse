...
{ //信号与槽的关联，当函数带有参数时，必须写明参数的类型
    ...
    connect(ui->toolBtnAbout, &QToolButton::clicked,
            this, &QWMainWind::on_toolBtnAbout_clicked);
}
...
void QWMainWind::on_toolBtnAbout_clicked()
{
    QMessageBox::about(this, "关于", "姓名: 袁伟珉\n学号: 2022463080329");
}
